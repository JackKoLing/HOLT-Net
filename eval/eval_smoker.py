...
class hoia():
    def __init__(self, annotation_file):
        ...
        self.verb_name_dict = {1: 'in_hand_and_mouth', 2: 'in_hand', 3: 'in_mouth'}
    ...
    def evalution(self, predict_annot):
        for pred_i in json.load(open(predict_annot, 'r')):
    ...
    def compute_IOU(self, bbox1, bbox2):
        ...
        if bbox1['category_id'] == bbox2['category_id']:
            ...
            # find the each edge of intersect rectangle找出交集
...
if __name__ == "__main__":
    test_gt = 'HOLT_gt.json'
    pred_json = 'HOLT-pred.json'


    hoi_eval = hoia(test_gt)
    map, rec = hoi_eval.evalution(pred_json)
    print('-------------------------------------------')
    print('mAP: {}   Recall: {}'.format(map, rec))
    print('-------------------------------------------')
